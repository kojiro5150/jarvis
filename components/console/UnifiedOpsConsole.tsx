  ...
  return (
    <main className="console-page">
        ...
        <div className="command-area">
          ...
          <div className="workspace">
            ...
            <div className="workspace-head">
              ...
              <div className="tabs"><b>ACTIVE</b><span>ARTIFACTS</span><span>FILES</span><span>MEMORY</span><span>REASONING</span><i className="reticle">⊙</i></div>
            </div>
      ...
      <style jsx global>{`
        ...
        @media(max-width:1400px){.console-page{padding:20px}.console-frame{height:calc(100dvh - 40px)}.status-items{gap:12px}.status-items span:nth-of-type(2),.status-items span:nth-of-type(3){display:none}.tabs{gap:12px}.tabs span{display:none}}
