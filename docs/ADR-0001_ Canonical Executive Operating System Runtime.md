...
\- \`docs/ENGINEERING\_CONSTITUTION.md\` governs engineering principles and repository evolution. In  
...
\- \`docs/architecture/NORTH\_STAR.md\` governs JARVIS's enduring purpose and desired executive  
...
\- \`DESIGN\_CONSTITUTION.md\` governs user-facing behaviour and interaction. It requires JARVIS to act  
