...
export interface CapabilityInvocationProvenance { readonly routingPlanId:string; readonly executiveContextId:string; readonly executiveStateSnapshotId:string; readonly executionPolicyId:string; readonly registryId:string; readonly capabilityId:string; readonly implementationId:string; readonly capabilityVersion:string; readonly implementationVersion:string; readonly routingContractVersion:string; readonly invocationContractVersion:string }
export interface CapabilityInvocationContext { readonly invocationId:string; readonly routingPlan:CapabilityRoutingPlan; readonly executiveContext:ExecutiveContext; readonly executionPolicy:ExecutionPolicy; readonly referenceTime:string; readonly provenance:CapabilityInvocationProvenance }
...
export interface CapabilityInvocationRequest { readonly routingPlan:CapabilityRoutingPlan; readonly executiveContext:ExecutiveContext; readonly executionPolicy:ExecutionPolicy; readonly referenceTime:string }
