...
const protectedHashes: Record<string, string> = {
  "lib/context-builder.ts": "8e689bf0880375ef2539c37cac8f8891669e66f4eb6ca72602fe97137438894d", "lib/agents/chat-execution.ts": "a8fc170c4273b0dc9e90ec1d85dfaf98c2b4aeddbae3e38380fbe4aad3533dc7",
...
describe("Sprint 3.93 pure-Node isolation", () => {
  it("has no production forward import and no prohibited reverse import", () => {
    ...
    for (const prohibited of ["context-builder", "useAgentConversation", "agents/chat-execution", "components/"]) expect(evaluation).not.toContain(prohibited);
  });
