...
import { GOVERNED_ENRICHED_CLAIM_INTEGRITY_POLICY_ID, type ClaimIntegrityDigest } from "./claim-integrity";
...
export interface EnrichedGovernedClaimInput extends GovernedClaimInput { readonly baseClaimId: string; readonly claimIntegrityPolicyId: typeof GOVERNED_ENRICHED_CLAIM_INTEGRITY_POLICY_ID; readonly claimIntegrityDigest: ClaimIntegrityDigest }
...
export type ClaimEnrichmentRecord = { readonly baseClaimId: string; readonly enrichedClaimId: string; readonly claimType: GovernedClaimInput["claimType"]; readonly admittedEvidenceCategories: readonly ClaimEnrichmentEvidenceCategory[]; readonly consultedSourceReferences: readonly GovernedSourceReference[]; readonly admittedSourceReferences: readonly GovernedSourceReference[]; readonly rejectedSourceReferences: readonly GovernedSourceReference[]; readonly reason: string } & ({ readonly outcome: Exclude<ClaimEnrichmentOutcome, "enrichment_failed">; readonly claimIntegrityPolicyId: typeof GOVERNED_ENRICHED_CLAIM_INTEGRITY_POLICY_ID; readonly claimIntegrityDigest: ClaimIntegrityDigest } | { readonly outcome: "enrichment_failed"; readonly claimIntegrityPolicyId?: never; readonly claimIntegrityDigest?: never })
