...
export interface GovernedCommunicationEvidenceInput { readonly communicationReference: string; readonly recipientEvidenceReference: string; readonly sourceReference: GovernedSourceReference; readonly provenanceReference: string; readonly retrievalTime: string; readonly available: boolean; readonly contentDigest?: string; readonly contentKind: string; readonly compatibilityBoundary: string; readonly policyReference: string; readonly senderDisplayName?: string }
