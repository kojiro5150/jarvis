...
const gmail: GmailProductionAcquisition = Object.freeze({ messages: [], observedAt: "2026-08-01T10:00:01.000Z", snapshotId: "google-gmail:snapshot", observations: Object.freeze([{ id: "provider-1", retrievedAt: "2026-08-01T10:00:01.000Z", internalDate: "1785582000000", payload: { headers: [{ name: "Message-ID", value: "<message@example.com>" }, { name: "From", value: "sender@example.com" }, { name: "To", value: "recipient@example.com" }, { name: "Date", value: "Thu, 1 Jan 2026 10:00:00 +0000" }] } }]) });
